# Deployment Guide for Open5e Developer RAG Server
...
```bash
cd F:\Github\mnehmos.index-foundry.mcp\projects\open5e-rag
npm install
```
...
gh repo create open5e-rag --public --push
```
...
3. Select your `open5e-rag` repository
...
3. Copy your URL: `https://open5e-rag-production.up.railway.app`
